import { Doctor } from '../../api/types'; // We might need to define types, or just use any for now
// Actually, let's define a simple interface here to avoid import issues
