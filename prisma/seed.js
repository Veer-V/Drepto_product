  ...
  const products = [
    {
      ...
      sideEffects: [
        'None observed when used as directed.',
        'Rare cases of mild skin irritation.',
        'Do not use on open wounds.',
      ],
      developmentStory:
        'Developed after years of research into transdermal herbal delivery systems. Our scientists combined ancient Ayurvedic wisdom with modern adhesive technology to create a patch that delivers sustained relief without the side effects of oral painkillers.',
    },
    {
      ...
      ingredients: [
        ...
        'Menthol',
        'Camphor',
        'Nirgundi Extract (Optional)',
      ],
      benefits: [
        'Instant Cooling Relief',
        'Long-Lasting Action (8-12 Hours)',
        'Reduces Muscle & Joint Pain',
        'Improves Micro-circulation',
        'Non-Greasy & Mess-Free',
      ],
      sideEffects: [
        'Minor redness may occur on sensitive skin.',
        'Avoid direct sun exposure on the patch.',
        'Discontinue use if itching persists.',
      ],
      developmentStory:
        'Aryasoothe was born from a need for non-invasive arthritis solutions. Clinical trials showed a 40% reduction in localized pain within 30 minutes of application, leading to its approval as a safe alternative to NSAID pills.',
    },
    {
      ...
      benefits: [
        ...
        'Anti-Inflammatory',
        'Post Surgery Relief',
        'Treats Strains & Sprains',
      ],
      sideEffects: [
        'Local skin reaction (rare).',
        'Consult doctor if pregnant.',
        'Do not use if allergic to NSAIDs.',
      ],
      developmentStory:
        'Surveda represents the pinnacle of 24-hour transdermal technology. Designed specifically for post-operative recovery and deep tissue inflammation, it provides continuous dosage stability that oral medication cannot match.',
    },
  ];
