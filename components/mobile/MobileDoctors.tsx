...
const doctors = [
  {
    ...
    exp: '10 yrs',
    rating: 4.8,
    image: 'https://placehold.co/100x100?text=Dr+Sarah',
  },
  {
    id: 2,
    name: 'Dr. John Doe',
    ...
    exp: '8 yrs',
    rating: 4.5,
    image: 'https://placehold.co/100x100?text=Dr+John',
  },
  {
    id: 3,
    name: 'Dr. Emily White',
    ...
    exp: '5 yrs',
    rating: 4.9,
    image: 'https://placehold.co/100x100?text=Dr+Emily',
  },
  {
    id: 4,
    ...
    exp: '12 yrs',
    rating: 4.7,
    image: 'https://placehold.co/100x100?text=Dr+Mike',
  },
];
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center text-xs text-gray-500 mt-1">
                <span className="bg-blue-50 text-blue-600 px-2 py-0.5 rounded mr-2">
                  {doc.exp} Exp
                </span>
