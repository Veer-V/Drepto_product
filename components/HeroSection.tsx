  ...
  return (
    <section className="bg-light-blue pt-24 md:pt-32 pb-16">
      <div className="container mx-auto px-6 text-center">
        <div className="max-w-3xl mx-auto">
          <div className="animate-fade-in-up">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Connect with certified doctors, order medicines, book lab tests,
              and arrange home care—all in one secure app.
            </p>
        ...
        <div
          className="mt-12 relative flex justify-center animate-fade-in-up"
