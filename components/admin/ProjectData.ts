...
const initialProjects: Project[] = [
  {
    ...
    description:
      'End-to-end development of Methotrexate Transdermal Patch from formulation to commercial launch.',
    status: 'In Progress',
    ...
    tasks: [
      ...
      {
        id: 'ph-1',
        title: 'Phase 1: Pre-Formulation & Formulation Development',
        assignee: 'Dr. Formulation',
        status: 'done',
        startDate: '2025-12-01',
        endDate: '2025-12-31',
        type: 'phase',
      ...
      {
        id: 'ph-2',
        title: 'Phase 2: Analytical Method Development & Validation',
        assignee: 'QA Core',
        status: 'todo',
      ...
      {
        id: 'ph-3',
        title: 'Phase 3: Preclinical Studies',
        assignee: 'Dr. Clinical',
        status: 'todo',
      ...
      {
        id: 'ph-3-1',
        title: 'In-Vitro / Ex-Vivo Studies',
        assignee: 'Lab Team',
        status: 'todo',
        startDate: '2026-03-01',
        endDate: '2026-04-30',
      ...
      {
        id: 'reg-pre-clin',
        title: 'Regulatory Phase (Pre-Clinical)',
        assignee: 'Reg. Affairs',
        status: 'todo',
      ...
      {
        id: 'ph-4',
        title: 'Phase 4: Clinical Studies',
        assignee: 'Dr. Clinical',
        status: 'todo',
      ...
      {
        id: 'launch',
        title: 'Commercial Manufacturing & Launch',
        assignee: 'Ops Manager',
        status: 'todo',
  ...
  },
  {
    ...
    description:
      'Mefenamic Acid + Dicyclomine OTC Patch. CT Waived path for accelerated launch.',
    status: 'In Progress',
    startDate: '2025-12-01',
    endDate: '2027-06-30',
    ...
    tasks: [
      ...
      {
        id: 'p3-ph-2',
        title: 'Phase 2: Analytical Method Development',
        assignee: 'QA Core',
        status: 'todo',
        startDate: '2026-01-01',
        endDate: '2026-02-28',
      ...
      {
        id: 'p3-ph-3',
        title: 'Phase 3: Preclinical Studies (Safety/Efficacy)',
        assignee: 'Lab Team',
        status: 'todo',
        startDate: '2026-03-01',
        endDate: '2026-07-31',
      ...
      {
        id: 'p3-reg',
        title: 'Regulatory & Licensing (CT Waived)',
        assignee: 'Reg. Affairs',
        status: 'todo',
        startDate: '2026-08-01',
        endDate: '2026-10-31',
      ...
      {
        id: 'p3-dossier',
        title: 'Dossier Compilation (Class C/D & Form 29)',
        assignee: 'Reg. Affairs',
        status: 'todo',
      ...
      {
        id: 'p3-launch',
        title: 'Final Approval & Market Launch',
        assignee: 'Ops Manager',
        status: 'todo',
        startDate: '2027-01-01',
        endDate: '2027-06-30',
...
const generateTenStageTasks = (projectId: string, start: string): Task[] => {
  ...
  const stages = [
    {
      title: '1. Literature Review & Concept',
      duration: 2,
      assignee: 'R&D Lead',
    },
    ...
    {
      title: '6. Refinement & Optimization',
      duration: 3,
      assignee: 'R&D Team',
    },
    { title: '7. Validation Studies', duration: 3, assignee: 'QA Core' },
    {
      title: '8. Regulatory Assessment',
      duration: 2,
      assignee: 'Reg. Affairs',
    },
    {
      title: '9. Pilot Production / Fabrication',
      duration: 2,
      assignee: 'Ops Manager',
    },
    {
      title: '10. Final Report & Tech Transfer',
      duration: 1,
...
const generate52MonthTasks = (projectId: string, start: string): Task[] => {
  ...
  const phases = [
    {
      title: 'Phase 1: Pre-Formulation & Formulation',
      duration: 6,
      assignee: 'Dr. Formulation',
      type: 'phase',
    },
    {
      title: 'Phase 2: Analytical Method Dev & Val',
      duration: 6,
      assignee: 'QA Core',
      type: 'phase',
    },
    ...
    {
      title: 'Phase 4-I: Clinical Phase I',
      duration: 6,
      assignee: 'Dr. Clinical',
      type: 'sub-phase',
    },
    {
      title: 'Phase 4-II: Clinical Phase II',
      duration: 12,
      assignee: 'Dr. Clinical',
      type: 'sub-phase',
    },
    {
      title: 'Phase 4-III: Clinical Phase III',
      duration: 10,
      assignee: 'Dr. Clinical',
      type: 'sub-phase',
    },
...
const newProjects: Project[] = [
  // Group 2: R&D Projects (Ten-Stage)
  {
    ...
    description:
      'Development of advanced sensor electrodes for bio-monitoring applications.',
    status: 'Planning',
    startDate: start2026,
  ...
  },
  {
    ...
    description:
      'Research into novel materials to prevent bio-fouling in implantable devices.',
    status: 'Planning',
    startDate: start2026,
    endDate: addMonths(start2026, 24),
  ...
  },
  {
    ...
    description:
      'Screening existing drugs for new therapeutic indications using reverse pharmacology.',
    status: 'Planning',
    startDate: start2026,
    endDate: addMonths(start2026, 24),
