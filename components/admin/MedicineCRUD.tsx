...
import {
  ...
  X,
  Image as ImageIcon,
} from 'lucide-react'; // Assuming we can use lucide-react, or I will use SVGs if not available.
      ...
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <button
            ...
            className="bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary/90 flex items-center gap-2 shadow-sm transition-all"
          >
            <PlusIcon />
            Add Medicine
          </button>
      ...
      <div className="p-8 space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="col-span-2">
              ...
              <input
                ...
                className="w-full border rounded-lg p-2.5 focus:ring-2 focus:ring-primary/20 outline-none transition-all"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                value={form.price}
                onChange={handleChange}
                className="w-full border rounded-lg p-2.5 outline-none focus:border-primary font-bold"
              />
            </div>
          </div>
        </section>
          ...
          <div className="flex gap-6 items-start">
            ...
            <div className="flex-1">
              ...
              <textarea
                ...
                value={form.images}
                onChange={handleChange}
                className="w-full border rounded-lg p-2.5 outline-none focus:border-primary h-24 text-sm font-mono"
              />
            </div>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              className="w-full border rounded-lg p-2.5 outline-none focus:border-primary h-32"
            />
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
        ...
        <section className="space-y-4 pb-8">
          ...
          <textarea
            ...
            onChange={handleChange}
            placeholder="Precautions (Format: Title: Advice)"
            className="w-full border rounded-lg p-2.5 h-20"
          />
        </section>
      </div>
