    ...
    <div className="min-h-screen bg-light-blue flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-primary text-white py-2 rounded-lg font-semibold hover:bg-teal-700 transition-colors"
          >
            Login
          </button>
          <button
            ...
            className="w-full text-primary mt-2 hover:underline"
          >
            Back to user login
          </button>
        </form>
