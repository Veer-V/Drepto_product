                        ...
                        <div className="text-center">
                            ...
                            <div className="text-left space-y-3 inline-block">
                                <p className="text-gray-700 flex items-center gap-2">
                                    <span className="font-bold text-primary">✉ Email:</span> office@dreptobiodevices.com
                                </p>
                                <p className="text-gray-700">
                                    <span className="font-bold text-primary">Working Hours:</span> Monday - Friday, 9am - 5pm IST
                                </p>
                            </div>
                        </div>
                    </div>
