...
const OfferCard: React.FC<{
  ...
  description: string;
  onAction: () => void;
}> = ({ title, code, description, onAction }) => (
  <div className="bg-white p-4 rounded-lg border-2 border-dashed border-gray-300 flex items-center hover:border-teal-400 transition-colors">
    <div className="flex-1">
      <p className="text-xs font-bold text-teal-600 bg-teal-50 inline-block px-2 py-0.5 rounded">
        {title}
      </p>
      ...
      <div className="mt-2">
        <button
          onClick={onAction}
          className="px-3 py-1 text-xs font-bold text-teal-700 border border-teal-600 rounded hover:bg-teal-50"
        >
          {code}
        </button>
      </div>
    ...
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden group flex flex-col transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
      <div className="relative h-48 bg-gray-50 flex items-center justify-center p-6">
        <img
          ...
          alt={product.name}
          className="h-full w-auto object-contain max-h-40 transition-transform duration-300 group-hover:scale-110"
        />
        {discount > 0 && (
      ...
      <div className="p-4 flex-grow flex flex-col">
        <p className="text-xs font-bold text-teal-600 uppercase mb-1 tracking-wide">
          {product.brand}
        </p>
        <h3 className="text-sm font-bold text-gray-900 flex-grow leading-snug mb-2 line-clamp-2">
          {product.name}
        </h3>
        ...
        <div className="mt-auto">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 py-2 bg-teal-600 text-white text-xs font-bold rounded-lg hover:bg-teal-700 transition-colors shadow-sm"
            >
              Add
            </button>
            <button
...
const Medicines: React.FC<MedicinesProps> = ({ onViewDetails }) => {
  ...
  const filtered = useMemo(() => {
    ...
    const source = all && all.length ? all : DEFAULT_MEDICINES;
    if (!q) return source;
  ...
  const handleWhatsApp = () => {
    const text = encodeURIComponent(
      'Hi! 👋 Can you help me place an order with Drepto Biodevices? 💊.',
    );
      ...
      <div className="md:hidden px-4 pt-4 pb-4 space-y-5 bg-white">
        ...
        <div className="bg-gradient-to-r from-teal-500 to-emerald-500 rounded-xl p-4 text-white shadow-lg mb-2">
          ...
          <p className="text-xs opacity-90">
            Your one-stop shop for all medicines & health products.
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2">
          ...
          <div className="bg-green-50 p-2 rounded-lg flex flex-col items-center justify-center text-center h-16 shadow-sm">
            <img
              src="https://cdn-icons-png.flaticon.com/512/2979/2979684.png"
              alt="Express"
              className="h-5 w-5 mb-1"
            />
          ...
          <div className="bg-purple-50 p-2 rounded-lg flex flex-col items-center justify-center text-center h-16 shadow-sm">
            <img
              src="https://cdn-icons-png.flaticon.com/512/1584/1584808.png"
              alt="Returns"
              className="h-5 w-5 mb-1"
            />
            <span className="text-[10px] font-bold text-purple-800 leading-tight">
              Easy
              <br />
              Returns
            </span>
        ...
        <div>
          ...
          <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide justify-center items-center">
            <button
              ...
              className="flex-shrink-0 flex items-center gap-1.5 bg-emerald-50 border border-emerald-100 px-2.5 py-2 rounded-lg shadow-sm"
            >
              <img
            ...
            <button
              ...
              className="flex-shrink-0 flex items-center gap-1.5 bg-blue-50 border border-blue-100 px-2.5 py-2 rounded-lg shadow-sm"
            >
              <img
                src="https://cdn-icons-png.flaticon.com/512/2301/2301134.png"
                alt="Upload"
                className="h-4 w-4"
              />
            ...
            <button
              onClick={handleCall}
              className="flex-shrink-0 flex items-center gap-1.5 bg-orange-50 border border-orange-100 px-2.5 py-2 rounded-lg shadow-sm"
            >
              <img
            ...
            <div className="min-w-[200px] snap-start bg-gradient-to-r from-pink-500 to-rose-500 p-3 rounded-xl text-white relative overflow-hidden shadow-md">
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-between">
                  <code className="bg-white/20 px-2 py-1 rounded text-[10px] font-mono">
                    FIRST25
                  </code>
                  <button
                    onClick={() => copyOffer('FIRST25')}
                    className="text-[10px] bg-white text-pink-600 px-2 py-1 rounded font-bold shadow-sm"
                  >
                    Copy
                  </button>
                </div>
            ...
            <div className="min-w-[200px] snap-start bg-gradient-to-r from-violet-500 to-purple-500 p-3 rounded-xl text-white relative overflow-hidden shadow-md">
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() => copyOffer('HEALTH15')}
                    className="text-[10px] bg-white text-violet-600 px-2 py-1 rounded font-bold shadow-sm"
                  >
                    Copy
                  </button>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-4 leading-tight">
              Get Medicines Fast with{' '}
              <span className="text-teal-400">Superfast Delivery</span>
            </h1>
            <p className="text-blue-200 text-lg font-medium">
              Genuine medicines, great discounts, and doorstep delivery.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            />
            <ServiceIcon
              icon="https://cdn-icons-png.flaticon.com/512/2979/2979684.png"
              title="Express Delivery"
              subtitle="Within 24 hours in select cities"
            />
            <ServiceIcon
              icon="https://cdn-icons-png.flaticon.com/512/1584/1584808.png"
              title="Easy Returns"
              subtitle="No questions asked return policy"
            />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 relative z-20">
          <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
            <div className="flex flex-col md:flex-row items-center gap-4 mb-8">
              ...
              <button
                onClick={() => setPage(1)}
                className="w-full md:w-auto px-8 py-4 bg-teal-600 text-white font-bold rounded-xl hover:bg-teal-700 transition-colors shadow-lg shadow-teal-200"
              >
                Search
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-4 text-center lg:text-left">
                  Quick Order Options
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <OrderOption
                    onClick={handleUploadClick}
                    icon="https://cdn-icons-png.flaticon.com/512/2301/2301134.png"
                    title="Upload Rx"
                    actionText="Upload"
                  />
                  <OrderOption
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <OfferCard
                    title="NEW USER"
                    description="Flat 25% OFF on first order > ₹1000"
                    code="FIRST25"
                    onAction={() => copyOffer('FIRST25')}
                  />
                  <OfferCard
                    title="HEALTH"
                    description="Get 15% OFF + 5% Cashback"
                    code="HEALTH15"
                    onAction={() => copyOffer('HEALTH15')}
                  />
                </div>
              </div>
            </div>
      ...
      <section className="bg-gray-50 pb-16 pt-4 md:pt-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center mb-6 md:mb-8">
            <h2 className="text-lg md:text-2xl font-extrabold text-gray-900 mb-4 md:mb-0 self-start md:self-auto">
              Popular Medicines
            </h2>
          ...
          {visible.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 bg-white rounded-xl shadow-sm border border-gray-100 text-center">
              ...
              <p className="text-gray-500 max-w-sm">
                We couldn't find any medicines matching your search or filter.
