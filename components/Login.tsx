...
const Login: React.FC<LoginProps> = ({ onToggleView }) => {
  ...
  return (
    <div>
      ...
      <h2 className="text-2xl font-bold text-center text-dark-blue mb-6">
        Login
      </h2>
      <form
      ...
      >
        ...
        {error && (
          <p className="text-red-500 text-sm bg-red-50 p-2 rounded-lg border border-red-100 flex items-center gap-2">
            <svg
              className="w-4 h-4"
              fill="none"
              stroke="currentColor"
        ...
        <button
          type="submit"
          className="w-full bg-primary text-white font-bold py-3.5 rounded-xl hover:bg-dark-blue transition-all shadow-lg hover:shadow-primary/30 transform hover:-translate-y-0.5"
        >
          Login
        </button>
      </form>
