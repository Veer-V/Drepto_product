...
const DoctorAppointment = React.lazy(
  () => import('./patient/DoctorAppointment'),
);
...
const HomeIcon = ({
  ...
  <svg
    ...
    className={cn('w-5 h-5', className, active ? 'text-white' : 'text-current')}
  >
...
const EnhancedPatientDashboard: React.FC<EnhancedPatientDashboardProps> = ({
  user,
}) => {
