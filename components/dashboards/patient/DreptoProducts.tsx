    ...
    <>
      <div className="animate-fade-in-up pb-10 relative">
        ...
        <div className="bg-orange-50 rounded-2xl p-8 mb-10 text-center relative overflow-hidden shadow-inner">
          ...
          <h3 className="text-2xl md:text-3xl font-bold text-orange-900 mb-2 relative z-10">
            Advanced Pain Relief
          </h3>
          <p className="text-orange-800/70 relative z-10">
            Innovative biodegradable patches for your wellness.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {products.map((product) => (
            <div
              key={product.id}
              className="bg-white rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 group overflow-hidden border border-gray-100 flex flex-col h-full"
            >
              <div className="relative h-64 overflow-hidden bg-gray-100">
                ...
                <div className="absolute bottom-4 left-4 text-white">
                  <h3 className="text-xl font-bold mb-1 shadow-black/50 drop-shadow-md">
                    {product.name}
                  </h3>
                </div>
              </div>
        ...
        >
          <div className="bg-white rounded-3xl w-full max-w-2xl max-h-[85vh] overflow-y-auto shadow-2xl flex flex-col relative animate-scale-up">
            ...
            <div className="h-64 sm:h-80 bg-gray-100 shrink-0 relative">
              ...
              <h2 className="absolute bottom-6 left-6 text-2xl sm:text-3xl font-bold text-white shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {selectedProduct.sideEffects && (
                  <div>
                    ...
                    <ul className="list-disc list-inside text-gray-600 space-y-1">
                      {selectedProduct.sideEffects.map((se, i) => (
                        <li key={i}>{se}</li>
                      ))}
                    </ul>
                  </div>
                  ...
                  <div className="bg-purple-50 rounded-xl p-4 border border-purple-100 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div>
                      <h4 className="font-bold text-gray-900 flex items-center gap-2">
                        <span className="bg-purple-100 text-purple-700 px-2 py-1 rounded text-xs uppercase tracking-wide">
                          Subscribe & Save
                        </span>
                        Regular Deliveries
                      </h4>
                      <p className="text-sm text-gray-600 mt-1">
                        Get up to 17% off with our subscription plans.
                      </p>
                    </div>
                    <button
                      onClick={() => {
            ...
            <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6">
              {cart.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-gray-400 space-y-4">
                  ...
                  <button
                    onClick={() => setIsCartOpen(false)}
                    className="px-6 py-2 bg-orange-100 text-orange-600 rounded-full font-bold text-sm"
                  >
                    Start Shopping
                  </button>
                </div>
                ...
                <>
                  <div className="space-y-4">
                    {cart.map((item, index) => (
                      <div
                        key={index}
                        className="flex gap-4 p-4 rounded-2xl border border-gray-100 bg-white shadow-sm hover:shadow-md transition-shadow"
                      >
          ...
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl p-6 relative animate-scale-up max-h-[90vh] overflow-y-auto">
            ...
            {!paymentSuccess ? (
              <>
                ...
                <button
                  disabled={
                    (!paymentMethod && cartTotal.total > 0) || paymentProcessing
                  }
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 mb-8 max-w-[260px] mx-auto">
                  You have successfully placed your order. Thank you for
                  choosing Drepto!
                </p>
                <button
                  onClick={() => {
              ...
              {plans.map((plan) => (
                <div
                  ...
                  onClick={async () => {
                    if (
                      confirm(
                        `Confirm subscription for ${plan.name} (${plan.price})?`,
                      )
                    ) {
                      setLoading(true);
                      try {
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">
                      {plan.features[0]} • {plan.features[2]}
                    </p>
                  </div>
                  <div className="text-right">
                    <div className="font-bold text-lg text-orange-600">
