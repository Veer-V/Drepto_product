      ...
      <div className="max-w-6xl mx-auto">
        {filteredPatients.length > 0 ? (
            ...
            <div className="grid grid-cols-1 md:hidden gap-4">
              {displayedPatients.map((patient) => (
                ...
                >
                  ...
                  <button className="w-full mt-4 py-2.5 bg-gray-50 text-gray-600 font-bold text-xs rounded-xl hover:bg-emerald-50 hover:text-emerald-600 transition-colors">
                    View History
                  </button>
                </div>
              ))}
                  ...
                  {displayedPatients.map((patient) => (
                    ...
                    >
                      ...
                      <td className="p-5 text-right">
                        <button className="px-4 py-2 rounded-lg bg-white border border-gray-200 text-gray-500 text-xs font-bold hover:bg-emerald-50 hover:text-emerald-600 hover:border-emerald-200 transition-all shadow-sm">
                          View Profile
                        </button>
                      </td>
                    </tr>
          ...
          <div className="text-center py-24 bg-white rounded-3xl border border-dashed border-gray-200 animate-fade-in-up">
            ...
            <button
              onClick={() => setIsAddModalOpen(true)}
              className="bg-emerald-500 text-white px-6 py-3 rounded-xl font-bold shadow-md hover:bg-emerald-600 transition-all"
            >
            ...
            <form onSubmit={handleAddPatient} className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 bg-gray-50 rounded-xl border-transparent focus:border-emerald-500 focus:bg-white focus:ring-0 transition-all"
              ...
              <button
                type="submit"
                className="w-full bg-emerald-500 text-white py-3 rounded-xl font-bold shadow-lg shadow-emerald-200 hover:bg-emerald-600 transition-all mt-2"
              >
                Register Patient
              </button>
            </form>
