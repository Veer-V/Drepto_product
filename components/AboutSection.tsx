    ...
    <section className="py-24 bg-gray-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-display font-bold text-dark-blue mb-4">
            Our Purpose
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="group bg-white p-10 rounded-3xl shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:bg-gradient-to-br hover:from-white hover:to-teal-50">
            ...
            <h2 className="text-3xl font-bold text-dark-blue mb-4 group-hover:text-primary transition-colors">
              Our Mission
            </h2>
            <p className="text-gray-600 text-lg leading-relaxed">
              ...
              patient-friendly transdermal methotrexate delivery solution. We
              aim to improve patient outcomes, safety, and compliance by
              reducing dosage requirements and side effects.
            </p>
          </div>
          ...
          <div className="group bg-white p-10 rounded-3xl shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:bg-gradient-to-br hover:from-white hover:to-blue-50">
            ...
            <h2 className="text-3xl font-bold text-dark-blue mb-4 group-hover:text-blue-600 transition-colors">
              Our Vision
            </h2>
            <p className="text-gray-600 text-lg leading-relaxed">
